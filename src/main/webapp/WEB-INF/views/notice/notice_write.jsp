				...
				<div class="container">
					<form action="/notice/notice_writePro" method="POST">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="제목" id="nsubject" name="nsubject">
						</div>
					
						<div class="form-group">
							<label for="ncontent">내용:</label>
							<textarea id="summernote" class="form-control" rows="5" id="ncontent" name="ncontent"></textarea>
